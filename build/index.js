...
class Projector {
  ...
  constructor(log, config) {
    this.createServices = () => {
      ...
      infoService.setCharacteristic(Characteristic.Manufacturer, 'Optoma').setCharacteristic(Characteristic.Model, this.model).setCharacteristic(Characteristic.SerialNumber, 'XXXXXX');
